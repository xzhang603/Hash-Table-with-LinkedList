...
class Table {
 ...
 private:
   ...
   //Return the number of Non-Empty Buckets in the entire hash Table
   int numNonEmptyBuck() const;
   
   //Return the number of Longest Chain in the entire hash Table
   ...
   //The hash Table that each bucket is a linklist
   ListType* hashset;
